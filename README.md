...
- [Consumer visual regression](Docs/VISUAL_REGRESSION.md) explains dedicated-Mac runner setup, all-tab iPhone and iPad baseline recording, light-only screenshot coverage, and the deferred dark-mode review.
